...
namespace PrimeFactor.UnitTest
{
    public class Tests
    {
        ...
        {
            var lines = _fileService.GetIntegerLinesFromInputFile(@"C:\Users\Chris\source\repos\ecmillan-dev\FormFreeAssessment\PrimeFactor.Console\input1.txt").ToArray();
        ...
        {
            Assert.Catch<InvalidIntegerInputException>(delegate { _fileService.GetIntegerLinesFromInputFile(@"‪C:\Users\Chris\source\repos\ecmillan-dev\FormFreeAssessment\PrimeFactor.Console\invalidinputline.txt"); });
            Assert.Catch<InvalidIntegerInputException>(delegate { _fileService.GetIntegerLinesFromInputFile(@"‪C:\Users\Chris\source\repos\ecmillan-dev\FormFreeAssessment\PrimeFactor.Console\lowervalue.txt"); });
        }
